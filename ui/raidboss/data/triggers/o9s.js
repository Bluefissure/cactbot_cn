...
[{
  ...
  triggers: [
    ...
    },
    {
      ...
      regexCn: /:(\y{Name}) gains the effect of (?:Unknown_640|混沌之炎) from  for (\y{Float}) Seconds/,
    ...
    },
    {
      ...
      regexCn: /:\y{Name} gains the effect of (?:Unknown_641|混沌之水) from/,
    ...
    },
    {
      ...
      regexCn: /:(\y{Name}) gains the effect of (?:Unknown_642|混沌之风) from  for (\y{Float}) Seconds/,
    ...
    },
    {
      ...
      regexCn: /:(\y{Name}) gains the effect of (?:Unknown_643|混沌之逆风) from  for (\y{Float}) Seconds/,
    ...
    },
    {
      ...
      regexCn: /:\y{Name} gains the effect of (?:Unknown_644|混沌之泥土)/,
    ...
    },
    {
      ...
      regexCn: /:(\y{Name}) gains the effect of (?:Unknown_645|混沌之土)/,
    ...
    // Orb Phase
    {
      ...
      regexCn: / 14:318A:卡奥斯 starts using Bowels Of Agony /,
    ...
    },
    {
      ...
      regexCn: /:(\y{Name}) gains the effect of (?:Unknown_641|混沌之水) from  for (\y{Float}) Seconds/,
