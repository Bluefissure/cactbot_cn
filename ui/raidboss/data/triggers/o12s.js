...
[{
  ...
  triggers: [
    ...
    },
    {
      ...
      regexCn: / 1A:欧米茄 gains the effect of (?:共鸣程序：远|Unknown_67F) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_67D|防护程序F) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_67C|防护程序M) from/,
    ...
    },
    {
      ...
      infoText: function(data, matches) {
        ...
        return {
          ...
          cn: '目标识别了' + data.ShortName(matches[1]),
        };
      },
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_688|回归方程：近) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_689|回归方程：远) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_681|严重错误：上溢) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_686|潜在错误) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_682|严重错误：下溢) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_680|严重错误：同步) from (?:.*) for (.*) Seconds/,
      ...
      infoText: function(data, matches) {
        ...
        if (t <= 8) {
          ...
          return {
            ...
            cn: '短D是' + data.ShortName(matches[1]),
          };
        }
        return;
      },
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_681|严重错误：上溢|Unknown_686|潜在错误|Unknown_680|严重错误：同步) from/,
    ...
    },
    {
      ...
      regexCn: / 1A:(\y{Name}) gains the effect of (?:Unknown_687|潜在错误：下溢) from/,
    ...
    },
    {
      ...
      regexDe: / 1B:........:Hintere Antriebseinheit:....:....:009D:0000:0000:0000:/,
      regexFr: / 1B:........:Rear Power Unit:....:....:009D:0000:0000:0000:/,
      regexJa: / 1B:........:Rear Power Unit:....:....:009D:0000:0000:0000:/,
      regexCn: / 1B:........:尾部组:....:....:009D:0000:0000:0000:/,
      alertText: {
        en: 'Back Left',
        de: 'Hinten Links',
        fr: 'Arrière gauche',
    ...
    },
    {
      ...
      regexDe: / 1B:........:Hintere Antriebseinheit:....:....:009C:0000:0000:0000:/,
      regexFr: / 1B:........:Rear Power Unit:....:....:009C:0000:0000:0000:/,
      regexJa: / 1B:........:Rear Power Unit:....:....:009C:0000:0000:0000:/,
      regexCn: / 1B:........:尾部组:....:....:009C:0000:0000:0000:/,
      alertText: {
        en: 'Back Right',
        de: 'Hinten Rechts',
        fr: 'Arrière droite',
    ...
    },
    {
      ...
      regexCn: / 1B:........:右臂组:....:....:009(C|D):0000:0000:0000:/,
      run: function(data, matches) {
