...
[{
  ...
  triggers: [
    ...
    },
    {
      ...
      regexCn: /1[56]:\y{ObjectId}:火角:26C5:烈?火球:\y{ObjectId}:(\y{Name}):/,
    ...
    },
    {
      ...
      regexCn: /:26E2:至尊巴哈姆特 starts using 进军的三重奏/,
    ...
    },
    {
      ...
      regexCn: /:26E3:至尊巴哈姆特 starts using 黑炎的三重奏/,
    ...
    },
    {
      ...
      regexCn: /:26E4:至尊巴哈姆特 starts using 灾厄的三重奏/,
    ...
    },
    {
      ...
      regexCn: /:26E5:至尊巴哈姆特 starts using 天地的三重奏/,
    ...
    },
    {
      ...
      regexCn: /:26E6:至尊巴哈姆特 starts using 连击的三重奏/,
    ...
    },
    {
      ...
      regexCn: /:26E7:至尊巴哈姆特 starts using 群龙的八重奏/,
    ...
    },
    {
      ...
      regexCn: /16:........:诸神黄昏:26B8:天崩地裂:........:(\y{Name}):/,
    ...
    // --- Twintania ---
    {
      ...
      regexCn: /:26AA:双塔尼亚 starts using/,
    ...
    },
    {
      ...
      regexCn: /:(\y{Name}) gains the effect of 死亡宣告 from .*? for (\y{Float}) Seconds/,
      regexDe: /:(\y{Name}) gains the effect of Verhängnis from .*? for (\y{Float}) Seconds/,
      regexFr: /:(\y{Name}) gains the effect of Glas from .*? for (\y{Float}) Seconds/,
      regexJa: /:(\y{Name}) gains the effect of 死の宣告 from .*? for (\y{Float}) Seconds/,
      condition: function(data, matches) {
    ...
    },
    {
      ...
      regexCn: /gains the effect of 死亡宣告/,
    ...
    },
    {
      ...
      regexCn: /:(冰爪:26C6|雷翼:26C7|光牙:26CA|暗尾:26C9|火角:26C5):.*:(\y{Float}):(\y{Float}):\y{Float}:\y{Float}:$/,
